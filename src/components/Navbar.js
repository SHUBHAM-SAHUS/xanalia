...
const NavbarSearch = connect((store) => ({
  ...
  return (
    <Form inline>
      <Input
        type="text"
        placeholder={intl.formatMessage({id: "searchProj"})}
        aria-label="Search"
    ...
    <Collapse navbar>
      ...
      <LangDropdown />
        ...
        <UncontrolledDropdown nav inNavbar className="ml-lg-1">
          ...
          <DropdownMenu right>
            <DropdownItem onClick={() => pushToRoute("/Settings")}>
              <FontAwesomeIcon icon={faUser} fixedWidth className="mr-2 align-middle" />
              View Profile
            </DropdownItem>
            <DropdownItem onClick={() => pushToRoute("/dashboard")} >
              <FontAwesomeIcon icon={faHome} fixedWidth className="mr-2 align-middle" />
              Dashboard
            </DropdownItem>
            <DropdownItem onClick={() => pushToRoute("/store")} >
              <FontAwesomeIcon icon={faStore} fixedWidth className="mr-2 align-middle" />
              Store
            </DropdownItem>
            <DropdownItem onClick={() => pushToRoute("/Settings")}>
