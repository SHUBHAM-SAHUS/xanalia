...
import { Breadcrumb, BreadcrumbItem, Card, CardHeader, CardTitle, Col, Container, Row, Table } from 'reactstrap';
...
const BasicTable = () => (
  <Card>
    ...
    <Table>
      ...
      <tbody>
        <tr>
          <td>Rio Bhupat Bheda</td>
          <td>864-348-0485</td>
          <td className="d-none d-md-table-cell">June 21, 1961</td>
          <td className="table-action">
            <FontAwesomeIcon icon={faPen} fixedWidth className="align-middle mr-1" />
  ...
  <Card>
    ...
    <Table striped hover>
      ...
      <tbody>
        <tr>
          <td>
            <img src={avatar5} width="48" height="48" className="rounded-circle mr-2" alt="Avatar" /> Michelle Bilodeau
          </td>
          <td>864-348-0485</td>
          <td>June 21, 1961</td>
        </tr>
        <tr>
          <td>
            <img src={avatar2} width="48" height="48" className="rounded-circle mr-2" alt="Avatar" /> Alexander Groves
          </td>
          <td>914-939-2458</td>
          <td>May 15, 1948</td>
        </tr>
        <tr>
          <td>
            <img src={avatar3} width="48" height="48" className="rounded-circle mr-2" alt="Avatar" /> Kathie Burton
          </td>
          <td>704-993-5435</td>
        ...
        <tr>
          <td>
            <img src={avatar4} width="48" height="48" className="rounded-circle mr-2" alt="Avatar" /> Daisy Seger
          </td>
          <td>765-382-8195</td>
          <td>April 2, 1971</td>
        </tr>
