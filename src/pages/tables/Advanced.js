  ...
  return (
    <Card>
      <CardHeader>
        ...
        <h6 className="card-subtitle text-muted">Pagination by react-bootstrap-table2</h6>
      </CardHeader>
      <CardBody>
        <BootstrapTable
          keyField="name"
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <h6 className="card-subtitle text-muted">Row selection by react-bootstrap-table2</h6>
      </CardHeader>
      <CardBody>
        <BootstrapTable
          bootstrap4
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <h6 className="card-subtitle text-muted">Expandable rows by react-bootstrap-table2</h6>
      </CardHeader>
      <CardBody>
        <BootstrapTable
          bootstrap4
...
const ExportCSVTable = () => {
  ...
  return (
    <Card>
      <ToolkitProvider keyField="name" data={tableData} columns={tableColumns} exportCSV>
        {(props) => (
          <div>
            <CardHeader>
              ...
              <h6 className="card-subtitle text-muted">Exportable CSV by react-bootstrap-table2</h6>
            </CardHeader>
            <CardBody>
              <BootstrapTable
                {...props.baseProps}
