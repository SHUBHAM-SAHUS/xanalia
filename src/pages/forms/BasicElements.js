...
const CustomCheckboxes = () => (
  <Card>
    ...
    <CardBody>
      <CustomInput type="checkbox" id="exampleCustomCheckbox" label="Custom checkbox" className="mb-2" />
      <CustomInput
        type="checkbox"
        ...
        className="mb-2"
      />
      <CustomInput type="checkbox" id="exampleCustomCheckbox3" label="Disabled custom checkbox" disabled />
    </CardBody>
  </Card>
);
...
const CustomSelects = () => (
  <Card>
    ...
    <CardBody>
      <CustomInput type="select" id="exampleCustomSelect" name="customSelect" className="mb-3">
      ...
      <CustomInput type="select" id="exampleCustomSelectMultiple" name="customSelectMultiple" multiple>
        <option value="">Open this select menu</option>
        <option>One</option>
        <option>Two</option>
        <option>Three</option>
...
const Sizes = () => (
  <Card>
    ...
    <CardBody>
      <Input type="text" placeholder="Large input" bsSize="lg" className="mb-3" />
...
const Radios = () => (
  <Card>
    ...
    <CardBody>
      <FormGroup check className="mb-2">
        <Label check>
          <Input type="radio" name="radio1" checked onChange={() => true} /> Option one is this and that—be sure to
  ...
  <Card>
    ...
    <CardBody>
      ...
      <CustomInput
        ...
        className="mb-2"
      />
      <CustomInput type="radio" id="exampleCustomRadio4" label="Other disabled custom radio" disabled />
    </CardBody>
  </Card>
);
...
const Switches = () => (
  <Card>
    ...
    <CardBody>
      ...
      <CustomInput type="switch" id="exampleCustomSwitch1" label="Disabled switch element" disabled />
    </CardBody>
  </Card>
);
...
const Selects = () => (
  <Card>
    ...
    <CardBody>
      <Input type="select" id="exampleCustomSelect" name="customSelect" className="mb-3">
        <option value="">Open this select menu</option>
        <option>One</option>
        <option>Two</option>
        <option>Three</option>
      ...
      <Input type="select" id="exampleCustomSelectMultiple" name="customSelectMultiple" multiple>
        <option value="">Open this select menu</option>
        <option>One</option>
        <option>Two</option>
        <option>Three</option>
  ...
  <Card>
    ...
    <CardBody>
      <FormGroup>
        ...
        <Input type="text" name="disabledInput" id="disabledInput" placeholder="Disabled input" disabled />
      </FormGroup>
      <FormGroup>
...
const ReadOnly = () => (
  <Card>
    ...
    <CardBody>
      <Input type="text" name="readonlyInput" id="readonlyInput" placeholder="Readonly input" readOnly />
    </CardBody>
  </Card>
);
