    ...
    <CardBody>
      <Form>
        ...
        <FormGroup>
          ...
          <Input type="textarea" name="textarea" placeholder="Textarea" rows="1" />
        </FormGroup>
        <FormGroup>
    ...
    <CardBody>
      <Form>
        ...
        <FormGroup row>
          ...
          <Col sm={10}>
            <Input type="textarea" name="textarea" placeholder="Textarea" rows="3" />
          </Col>
        </FormGroup>
        <FormGroup row>
          ...
          <Col sm={10}>
            <div className="custom-controls-stacked">
              <CustomInput
                ...
                defaultChecked
              />
              <CustomInput type="radio" id="radio2" name="customRadio" label="Second default radio" className="mb-2" />
              <CustomInput type="radio" id="radio3" label="Disabled radio" disabled />
            </div>
          </Col>
        </FormGroup>
        <FormGroup row>
          ...
          <Col sm={10}>
            <CustomInput type="checkbox" id="checkbox" label="Check me out" disabled />
          </Col>
        </FormGroup>
        <FormGroup row>
  ...
  <Card>
    ...
    <CardBody>
      <Form inline>
        ...
        <FormGroup className="mb-2 mr-sm-2 mb-sm-0">
          <CustomInput type="checkbox" id="checkbox" label="Remember me" disabled />
        </FormGroup>
        <Button color="primary">Submit</Button>
      </Form>
    </CardBody>
