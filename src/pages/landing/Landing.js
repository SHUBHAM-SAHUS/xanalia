...
import { Button, Card, CardBody, Col, Container, Row, Navbar, NavbarBrand } from 'reactstrap';
...
import XanaliaLogo from '../../components/XanaliaLogo'
          ...
          <Row>
            <Col md={12} xl={8} className="mx-auto text-center">
              <div className="d-block my-4">
                ...
                <div className="my-4">
                  <img src={brandBootstrap} alt="Bootstrap" width="40" className="align-middle mr-2" />{' '}
                  <img src={brandSass} alt="Sass" width="40" className="align-middle mr-2" />{' '}
                  <img src={brandWebpack} alt="Webpack" width="40" className="align-middle mr-2" />{' '}
                  <img src={brandNpm} alt="NPM" width="40" className="align-middle mr-2" />{' '}
                  <img src={brandReact} alt="React" width="42" className="align-middle" />{' '}
                  <img src={brandRedux} alt="Redux" width="34" className="align-middle" />
                </div>
              </div>
            </Col>
          </Row>
...
const Navigation = () => (
  <div className="py-3 bg-white landing-nav">
    <Container className="text-center">
      <Button tag={Link} to="/dashboard" color="primary" size="lg" target="_blank" className="btn-pill">
        Preview
      </Button>
      <Button
        tag={Link}
      ...
      <Button tag={Link} to="/docs/changelog" color="link" size="lg" target="_blank" className="btn-pill text-dark">
        Changelog
      </Button>
      <Button href="mailto:support@bootlab.io" color="link" size="lg" target="_blank" className="btn-pill text-dark">
        Support
      </Button>
    </Container>
  </div>
  ...
  <section className="py-6">
    <Container>
      <div className="mb-4 text-center">
        ...
        <p className="text-muted">Multiple color schemes available to make this template your very own.</p>
      </div>
    ...
    <Container>
      <div className="mb-4 text-center">
        ...
        <p className="text-muted">
          Here's what some of our 2,500 customers have to say about working with our products.
        </p>
      </div>
          ...
          <Card tag="blockquote" className="border">
            <CardBody className="p-4">
              <div className="d-flex align-items-center mb-3">
                <div>
                  <img src={brandBootstrapB} width="48" height="48" alt="Bootstrap" />
                </div>
                <div className="pl-3">
                  <h5 className="mb-1 mt-2">Nikita</h5>
                  <small className="d-block text-muted h5 font-weight-normal">Bootstrap Themes</small>
                </div>
              </div>
              <p className="lead mb-2">
                “We are totally amazed with a simplicity and the design of the template. Probably saved us hundreds of
                hours of development. We are absolutely amazed with the support Bootlab has provided us.”
              </p>
        ...
        <Col md={6} lg={4}>
          <Card tag="blockquote" className="border">
            <CardBody className="p-4">
              ...
              <p className="lead mb-2">
                “Everything is so properly set up that any new additions I'd make would feel like a native extension of
                the theme versus a simple hack. I definitely feel like this will save me hundredths of hours I'd
        ...
        <Col md={6} lg={4}>
          <Card tag="blockquote" className="border">
            <CardBody className="p-4">
              ...
              <p className="lead mb-2">
                “As a DB guy, this template has made my life easy porting over an old website to a new responsive
                version. I can focus more on the data and less on the layout.”
              </p>
        ...
        <Col md={6} lg={4}>
          <Card tag="blockquote" className="border">
            <CardBody className="p-4">
              ...
              <p className="lead mb-2">
                “This template was just what we were after; its modern, works perfectly and is visually beautiful , we
                couldn't be happier. The support really is excellent, I look forward to working with these guys for a
                long time to come!”
              </p>
        ...
        <Col md={6} lg={4}>
          <Card tag="blockquote" className="border">
            <CardBody className="p-4">
              ...
              <p className="lead mb-2">
                “I just began to test and use this theme and I can find that it cover my expectatives. Good support from
                the developer.”
              </p>
    ...
    <Container className="text-center">
      <Row>
        <Col lg={6} className="mx-auto">
          <h2 className="mb-3">Join over 2,500 developers who are already working with our products</h2>
          <Button
            href="https://themes.getbootstrap.com/product/spark-admin-dashboard-template-reactjs/"
            target="_blank"
            rel="noreferrer noopener"
