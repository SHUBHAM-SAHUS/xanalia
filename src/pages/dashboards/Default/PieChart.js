  ...
  return (
    <Card className="flex-fill w-100">
      <CardHeader>
        ...
        <FormattedMessage id="browserUsage"/>
        </CardTitle>
      </CardHeader>
        ...
        <div className="align-self-center w-100">
          ...
          <Table className="mb-0">
            <tbody>
              <tr>
                <td>
                  <FontAwesomeIcon icon={faCircle} className="text-primary" /> Chrome
                </td>
                <td className="text-right">4401</td>
              </tr>
              <tr>
                <td>
                  <FontAwesomeIcon icon={faCircle} className="text-warning" /> Firefox
                </td>
