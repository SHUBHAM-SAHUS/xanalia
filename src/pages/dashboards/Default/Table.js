  ...
  <Card className="flex-fill w-100">
    <CardHeader>
      ...
      <CardTitle tag="h5" className="mb-0">
        <FormattedMessage id="topSellProds"/>
      </CardTitle>
    </CardHeader>
    <Table striped className="my-0">
      <thead>
        <tr>
          ...
          <th className="d-none d-xl-table-cell"><FormattedMessage id="startDate"/></th>
          <th className="d-none d-xl-table-cell"><FormattedMessage id="endDate"/></th>
          <th><FormattedMessage id="status"/></th>
          <th className="d-none d-md-table-cell"><FormattedMessage id="asssignee"/></th>
        </tr>
      </thead>
      <tbody>
        <tr>
