...
import { Breadcrumb, BreadcrumbItem, Button, Container, Row, Col, Card, CardBody, Table } from 'reactstrap';
        ...
        <Card>
          <CardBody className="m-sm-3 m-md-5">
            <div className="mb-4">
              ...
              <br /> This is the receipt for a payment of <strong>$268.00</strong> (USD) you made to Xanalia.
            </div>
            ...
            <Row className="mb-4">
              ...
              <Col md="6" className="text-md-right">
                ...
                <strong>Xanalia LLC</strong>
                <p>
                  354 Roy Alley <br /> Denver <br /> 80202 <br /> USA <br />
                  <a href="mailto:info@Xanalia.com">info@Xanalia.com</a>
                </p>
              </Col>
            </Row>
            ...
            <Table size="sm">
              ...
              <tbody>
                <tr>
                  <td>Xanalia Theme Customization</td>
                  <td>2</td>
