    ...
    <CardBody>
      <Row noGutters>
        <Col sm="3" xl="12" className="col-xxl-4 text-center">
          <img src={avatar3} width="64" height="64" className="rounded-circle mt-2" alt="Charissa Hilt" />
        </Col>
        <Col sm="9" xl="12" className="col-xxl-8">
          <strong><FormattedMessage id="aboutMe"/></strong>
          <p>
      ...
      <Table size="sm" className="my-2">
        <tbody>
          ...
          <tr>
            <th><FormattedMessage id="occupation"/></th>
          ...
          <tr>
            <th><FormattedMessage id="website"/></th>
...
const Clients = () => (
  <Container fluid>
    <Header>
      <HeaderTitle><FormattedMessage id="clients"/> </HeaderTitle>
      ...
      <Breadcrumb>
        ...
        <BreadcrumbItem active><FormattedMessage id="clients"/></BreadcrumbItem>
      </Breadcrumb>
    </Header>
