      ...
      <Col lg="12">
        <Card>
          ...
          <CardBody>
            <div id="plugins">
              <p className="mb-4">
                This template comes with multiple plugins for the demo pages, here is the list with the official
                documentation/website for each one.
              </p>
              ...
              <Table>
                ...
                <tbody>
                  ...
                  <tr>
                    <td>ApexCharts</td>
                    <td>
                      <a href="https://apexcharts.com/" target="_blank" rel="noopener noreferrer">
                  ...
                  <tr>
                    <td>Dragula</td>
                    <td>
                      <a href="https://bevacqua.github.io/dragula/" target="_blank" rel="noopener noreferrer">
                  ...
                  <tr>
                    <td>FullCalendar</td>
                    <td>
                      <a href="https://fullcalendar.io/" target="_blank" rel="noopener noreferrer">
