...
const Badges = () => (
  <Card>
    ...
    <CardBody>
      ...
      <div>
        {colors.map((color, index) => (
          <Badge key={index} color={color.value} className="badge-pill mr-1 mb-1">
            {color.name}
          </Badge>
        ))}
      </div>
...
const Dropdowns = () => (
  <Card>
    <CardHeader>
      ...
      <h6 className="card-subtitle text-muted">Toggle contextual overlays for displaying lists of links.</h6>
    </CardHeader>
    <CardBody>
      <Row className="mb-3">
...
const Images = () => (
  <Card>
    ...
    <CardBody className="text-center">
      <img className="rounded mr-2 mb-2" src={avatar1} alt="Placeholder" width="140" height="140" />
      <img className="rounded-circle rounded mr-2 mb-2" src={avatar1} alt="Placeholder" width="140" height="140" />
      <img className="img-thumbnail rounded mr-2 mb-2" src={avatar1} alt="Placeholder" width="140" height="140" />
    </CardBody>
  </Card>
);
    ...
    <CardBody className="text-center">
      {directions.map((direction, index) => (
        <React.Fragment key={index}>
          <Button id={'UncontrolledPopover' + direction.name} type="button" className="mr-1">
            Popover on {direction.value}
          </Button>
          <UncontrolledPopover placement={direction.value} target={'UncontrolledPopover' + direction.name}>
...
const Tooltips = () => (
  <Card>
    ...
    <CardBody className="text-center">
      {directions.map((direction, index) => (
        <React.Fragment key={index}>
          <Button id={'UncontrolledTooltip' + direction.name} type="button" className="mr-1">
            Tooltip on {direction.value}
          </Button>
          <UncontrolledTooltip placement={direction.value} target={'UncontrolledTooltip' + direction.name}>
            Tooltip on {direction.value}
          </UncontrolledTooltip>
        </React.Fragment>
      ))}
  ...
  <Card>
    ...
    <CardBody>
      ...
      <div className="mb-2">
        ...
        {colors.map((color, index) => (
          <Spinner key={index} color={color.value} type="grow" className="mr-2" />
        ))}
      </div>
      ...
      <div className="mb-2">
        ...
        {colors.map((color, index) => (
          <Spinner key={index} color={color.value} type="grow" size="sm" className="mr-2" />
        ))}
      </div>
    </CardBody>
  </Card>
