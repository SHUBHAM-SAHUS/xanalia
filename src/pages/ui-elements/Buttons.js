...
const BasicButtons = () => (
  <Card>
    ...
    <CardBody className="text-center">
      ...
      <div>
        {colors.map((color, index) => (
          <Button key={index} color={color.value} className="mr-1 mb-1" disabled>
            {color.name}
          </Button>
        ))}
      </div>
...
const RoundedButtons = () => (
  <Card>
    ...
    <CardBody className="text-center">
      <div className="mb-3">
        {colors.map((color, index) => (
          <Button key={index} color={color.value} className="btn-pill mr-1 mb-1">
            {color.name}
          </Button>
        ))}
      </div>
      <div>
        {colors.map((color, index) => (
          <Button key={index} color={color.value} className="btn-pill mr-1 mb-1" disabled>
            {color.name}
          </Button>
        ))}
      </div>
...
const OutlineButtons = () => (
  <Card>
    ...
    <CardBody className="text-center">
      ...
      <div>
        {colors.map((color, index) => (
          <Button key={index} color={color.value} className="mr-1 mb-1" disabled outline>
            {color.name}
          </Button>
        ))}
      </div>
