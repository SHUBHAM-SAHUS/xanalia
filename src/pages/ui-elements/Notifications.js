...
class Notifications extends React.Component {
  ...
  showToastr() {
    ...
    toastrInstance(this.state.title, this.state.message || 'Have fun storming the castle!', options);
  }
      ...
      <Container fluid>
        ...
        <Card>
          <CardHeader>
            ...
            <h6 className="card-subtitle text-muted">Toastr notifications by react-redux-toastr</h6>
          </CardHeader>
          <CardBody>
            <Row>
              <Col md="7">
                ...
                <FormGroup>
                  <div>
                    ...
                    <CustomInput
                      ...
                      onChange={() => this.setState({ progressBar: !this.state.progressBar })}
                    />
                  </div>
                </FormGroup>
              </Col>
                ...
                <FormGroup>
                  ...
                  <div>
                    ...
                    <CustomInput
                      ...
                      onChange={() => this.setState({ position: 'bottom-right' })}
                      className="mb-2"
                    />
                    <CustomInput
                      type="radio"
                      ...
                      onChange={() => this.setState({ position: 'bottom-center' })}
                      className="mb-2"
                    />
                    <CustomInput
                      type="radio"
                      ...
                      onChange={() => this.setState({ position: 'bottom-left' })}
                      className="mb-2"
                    />
                  </div>
                </FormGroup>
            ...
            <Button onClick={() => this.showToastr()} type="button" className="mr-1" color="primary">
              Show notification
            </Button>
          </CardBody>
        </Card>
